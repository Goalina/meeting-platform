...
API_PREFIX = CONF.get("API_PREFIX")
COMMUNITY_SUPPORT = CONF["COMMUNITY_SUPPORT"]
COMMUNITY_PORTAL = CONF.get("COMMUNITY_PORTAL")

# 获取config2
COMMUNITY_ZOOM_OBS = VAULT_CONF.get("COMMUNITY_ZOOM_OBS")
COMMUNITY_HOST = VAULT_CONF.get("COMMUNITY_HOST")
COMMUNITY_SMTP = VAULT_CONF.get("COMMUNITY_SMTP")
COMMUNITY_KAFKA = VAULT_CONF.get("COMMUNITY_KAFKA")
COMMUNITY_OBS = VAULT_CONF.get("COMMUNITY_OBS")
COMMUNITY_BILI = VAULT_CONF.get("COMMUNITY_BILI")
COMMUNITY_AUDIT = VAULT_CONF.get("COMMUNITY_AUDIT")
COMMUNITY_TRANSLATE = VAULT_CONF.get("COMMUNITY_TRANSLATE")
